  ...
  * ========================== */
  ...
  $.fn.markdown.defaults = {
    ...
    buttons: [
      ...
      //    title: 'Preview',
      //    btnText: '<b>f(x)<b>',
      //    btnClass: 'btn btn-markdown-1 btn-sm',
      //    callback: function(e){
            ...
            data: [
                {
                    ...
                    name: 'addFunc',
                    title: 'Function',
                    icon: { glyph: 'glyphicon glyphicon-pencil', fa: 'fa fa-link', 'fa-3': 'icon-link' },
                    callback: function (e) {
                        var chunk, cursor, selected = e.getSelection(), content = e.getContent(), func = "[FUNC][/FUNC]"
